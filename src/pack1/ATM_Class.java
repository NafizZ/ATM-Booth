...
public class ATM_Class {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ATM_Class window = new ATM_Class();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setTitle("Nafiz Bank ATM BOOTH");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (k == 1) {
						...
						JButton btnNewButton007 = new JButton("new button");
						btnNewButton007.setBackground(Color.CYAN);
						btnNewButton007.setFont(new Font("Stencil Std", Font.BOLD, 16));
						btnNewButton007.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								JFrame frame007 = new JFrame("Details");
								frame007.setBounds(300, 300, 550, 500);
								frame007.getContentPane().setBackground(Color.CYAN);
								frame007.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
								frame007.getContentPane().setLayout(null);
								frame007.setVisible(true);
								
								
								String thisLine = null;
								String name = null, age = null, address = null, acNum = null;
								try {
									FileReader in = new FileReader("details007.txt");
									BufferedReader br = new BufferedReader(in);
									int D1 = 30, N1 = 1;
									...
									while ((thisLine = br.readLine()) != null) {
										...
										JLabel lblNewLabel = new JLabel(N1+")" +"Name = " + name);
										lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 20));
										lblNewLabel.setBounds(100, D1, 250, 35);
										frame007.getContentPane().add(lblNewLabel);
										D1 = D1+40;
										JLabel lblNewLabel2 = new JLabel("Account Number = " + acNum);
										lblNewLabel2.setFont(new Font("Tahoma", Font.BOLD, 20));
										lblNewLabel2.setBounds(100, D1, 350, 35);
										frame007.getContentPane().add(lblNewLabel2);
										D1 = D1+40;
										JLabel lblNewLabel3 = new JLabel("Age = " + age);
										lblNewLabel3.setFont(new Font("Tahoma", Font.BOLD, 20));
										lblNewLabel3.setBounds(100, D1, 250, 35);
										frame007.getContentPane().add(lblNewLabel3);
										D1 = D1+40;
										JLabel lblNewLabel4 = new JLabel("Address = " + address + '\n');
										lblNewLabel4.setFont(new Font("Tahoma", Font.BOLD, 20));
										lblNewLabel4.setBounds(100, D1, 250, 35);
										frame007.getContentPane().add(lblNewLabel4);
										D1 = D1+40;
										N1++;
									}
									br.close();
								...
								JScrollPane scrollPane = new JScrollPane(frame007);
								scrollPane.setBounds(5, 5, 300, 200);
								
								frame007.getContentPane().add(scrollPane);
								
								
								JButton btnBack = new JButton("Back");
								btnBack.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
										frame007.setVisible(false);
										frame.setVisible(true);
									}
								});
								btnBack.setBounds(315, 300, 120, 35);
								frame007.getContentPane().add(btnBack);
								
								
							}
						});
						btnNewButton007.setBounds(140, 8, 225, 33);
						frame.getContentPane().add(btnNewButton007);
						...
						btnNewButton.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								JOptionPane.showMessageDialog(null, "                              " + balance,
										"Your Balance", JOptionPane.CLOSED_OPTION);
							}
						});
									...
									public void actionPerformed(ActionEvent e) {
										...
										if (wb.compareTo("0") == 0) {
											...
											JOptionPane.showMessageDialog(null,
													"Not Enough Balance." + "Your Current Balance is " + balance,
													"Balance Status", JOptionPane.CLOSED_OPTION);
										} else {
											Account ac1 = new Account();
											// call check Balance function from account
											String balance = ac1.checkBalance(txtUserName.getText()) + " Tk";
											JOptionPane.showMessageDialog(null,
													" you Successfully withdraw " + txtAmount.getText() + "tk" +'\n' + "Your current balance :"+ balance,
													"Balance Status", JOptionPane.CLOSED_OPTION);
										}
							...
							public void actionPerformed(ActionEvent e) {
										...
										if (UserBalance > amount && amount > 0) {
											...
											if (TransferMoney == 0) {
												JOptionPane.showMessageDialog(null,
														...
														"Account Status", JOptionPane.CLOSED_OPTION);
											}
												...
												if (withdrawMoney.compareTo("0") == 0) {
													...
													// call check Balance function from account
													String balance = ac2.checkBalance(txtUserName.getText()) + " Tk";
													JOptionPane.showMessageDialog(null,
															"          you Successfully " + "transfer your money "+'\n'+ "  Your current balance :"+ balance,
								...
								btnCheck.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
										...
										AccountDetails ad = new AccountDetails(txtUserName.getText(),
												txtPassword.getText());
						...
						btnExit.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								frame = new JFrame("Exit");
								if (JOptionPane.showConfirmDialog(frame, "Confirm if u want to Exit",
										"ATM Login System", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION) {
									System.exit(0);
								}
